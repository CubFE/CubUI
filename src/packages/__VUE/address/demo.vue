<template>
  <div class="demo">
    ...
    <cub-cell :title="translate('title')" :desc="one" is-link @click="showAddress"></cub-cell>
    ...
    <cub-cell :title="translate('title')" :desc="six" is-link @click="showSelected"></cub-cell>
    ...
    <cub-cell :title="translate('title')" :desc="five" is-link @click="showAddress2"></cub-cell>
    ...
    <cub-cell :title="translate('title')" :desc="two" is-link @click="showAddressExist"></cub-cell>
    ...
    <cub-cell :title="translate('title')" :desc="three" is-link @click="showCustomImg"></cub-cell>
    ...
    <cub-cell :title="translate('title')" :desc="four" is-link @click="showAddressOther"></cub-cell>
...
import { HeartFill, Heart1 } from '@cubfe/icons-vue';
