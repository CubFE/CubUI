...
import { Address } from '@cubui/cubui';
...
```html
<template>
  <cub-cell title="Choose Address" :desc="text" is-link @click="showAddress"></cub-cell>
  <cub-address
...
```html
<template>
  <cub-cell title="Choose City" :desc="text" is-link @click="showAddress"></cub-cell>
  <cub-address
    v-model="value"
    v-model:visible="showPopup"
    :province="province"
...
```html
<template>
  <cub-cell title="Choose Address" :desc="text" type="custom2" is-link @click="showAddress"></cub-cell>
  <cub-address
    v-model="value"
    v-model:visible="showPopup"
    type="custom2"
...
```html
<template>
  <cub-cell title="Choose Address" :desc="text" is-link @click="showAddressExist"></cub-cell>
  <cub-address
...
```html
<template>
  <cub-cell title="Choose Address" :desc="text" is-link @click="showAddressOther"></cub-cell>
  <cub-address
