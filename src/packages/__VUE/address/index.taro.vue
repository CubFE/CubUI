<template>
  ...
  >
    <view class="cub-address">
      ...
      <view class="cub-address__custom" v-if="['custom', 'custom2'].includes(privateType)">
        <view class="cub-address__region" ref="tabRegion">
          ...
          >
            ...
            <view :class="{ 'cub-address__region-line--mini': true, active: index == tabIndex }"></view>
          </view>
          <view class="active cub-address__region-item" v-if="tabIndex == selectedRegion.length">
            ...
            <view class="cub-address__region-line--mini active"></view>
          </view>
        </view>

        <view class="cub-address__detail" v-if="privateType == 'custom'">
          <div class="cub-address__detail-list">
            <cub-scroll-view
              :scroll-y="true"
              :style="{ height: '100%' }"
              ...
              >
                <div>
                  <slot name="icon" v-if="selectedRegion[tabIndex]?.id == item.id">
                    <Check class="cub-address-select-icon" width="13px"></Check> </slot
                  >{{ item.name }}
                </div>
              </div>
            </cub-scroll-view>
      ...
      <!-- 配送至 -->
      <view class="cub-address__exist" v-else-if="privateType == 'exist'">
        <div class="cub-address__exist-group">
          <ul class="cub-address__exist-group-list">
            <li
              class="cub-address__exist-group-item"
            ...
            >
              <slot name="unselected-icon" v-if="!item.selectedAddress">
                <Location2 class="cub-address-select-icon" width="13px"></Location2>
              </slot>

              <slot name="icon" v-if="item.selectedAddress">
                <Check class="cub-address-select-icon" width="13px"></Check>
              </slot>

              <div class="cub-address__exist-item-info">
                <div class="cub-address__exist-item-info-top" v-if="item.name && item.phone">
                  <div class="cub-address__exist-item-info-name">{{ item.name }}</div>
                  <div class="cub-address__exist-item-info-phone">{{ item.phone }}</div>
                </div>
...
import { Location, Location2, Check, Close, Left } from '@cubfe/icons-vue-taro';
