...
test('Avatar: size props', async () => {
  ...
  const avatar: any = wrapper.find('.cub-avatar');
  expect(avatar.classes()).toContain('cub-avatar-small');
  await wrapper.setProps({ size: 'large' });
  expect(avatar.classes()).toContain('cub-avatar-large');
...
test('Avatar: shape props', () => {
  ...
  const avatar: any = wrapper.find('.cub-avatar');
  expect(avatar.classes()).toContain('cub-avatar-square');
});
