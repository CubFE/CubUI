<template>
  ...
  >
    ...
    <view class="cub-calendar__header">
      ...
      <view class="cub-calendar__weekdays">
        <view
    ...
    <cub-scroll-view
      ...
      :scroll-y="true"
      class="cub-calendar__content"
      @scroll="mothsViewScroll"
      :scroll-with-animation="scrollWithAnimation"
      ref="months"
    >
      <view class="cub-calendar__panel" :style="{ height: containerHeight }">
        <view class="cub-calendar__body" :style="{ transform: `translateY(${translateY}px)` }">
