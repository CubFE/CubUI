<template>
  <div class="cub-circle-progress" :style="{ height: Number(radius) * 2 + 'px', width: Number(radius) * 2 + 'px' }">
    <svg viewBox="0 0 100 100">
      ...
      <path class="cub-circle-progress__path" :style="pathStyle" :d="path" fill="none" :stroke-width="strokeWidth">
        >
      </path>
      <path
        class="cub-circle-progress__hover"
        :style="hoverStyle"
        :d="path"
        fill="none"
        :stroke="hoverColor"
    ...
    <div class="cub-circle-progress__text">
      <slot>
        <div>{{ progress }}%</div>
      </slot>
    </div>
