<template>
  <div class="demo">
    <cub-cell-group :title="translate('funUse')">
      <cub-cell :title="translate('basic')" @click="baseClick"></cub-cell>
      <cub-cell :title="translate('transparent')" @click="transparentClick"></cub-cell>
      <cub-cell :title="translate('html')" @click="htmlClick"></cub-cell>
      <cub-cell :title="translate('beforeClose')" @click="beforeCloseClick"></cub-cell>
      <cub-cell :title="translate('noTitle')" @click="noTitleClick"></cub-cell>
      <cub-cell :title="translate('tipDialog')" @click="tipsClick"></cub-cell>
      <cub-cell :title="translate('title')" @click="verticalClick"></cub-cell>
    </cub-cell-group>
    <cub-cell-group :title="translate('title1')">
      <cub-cell :title="translate('title1')" @click="componentClick"></cub-cell>
      <cub-dialog
        teleport="#app"
      ...
      <cub-cell :title="translate('title')" @click="componentvVrticalClick"></cub-cell>
      <cub-dialog
    ...
    <cub-cell-group :title="translate('title2')">
...
import { showDialog } from '@/packages/cubui.vue';
