<template>
  <view :class="classes">
    <cub-scroll-view
      class="cub-elevator__list cub-elevator__list--mini"
    ...
    >
      <view :style="fixedStyle" class="cub-elevator__list__fixed__wrapper" v-show="scrollY > 0">
        <view class="cub-elevator__list__fixed cub-elevator__list__fixed--mini" v-if="isSticky">
          <span class="cub-elevator__fixed-title">{{ indexList[currentIndex][acceptKey] }}</span>
        </view>
      </view>
      <view
        :class="['cub-elevator__list__item', `elevator__item__${index}`]"
    ...
    <view class="cub-elevator__code--current" v-show="scrollStart" v-if="indexList.length > 0">
