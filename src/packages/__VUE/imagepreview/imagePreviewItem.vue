<template>
  <cub-swiper-item @click="closeSwiper">
    <view
      :style="imageStyle"
      class="cub-image-preview-box"
      @touchstart="onTouchStart"
      @touchmove="onTouchMove"
      @touchend="onTouchEnd"
      @touchcancel="onTouchEnd"
    >
      <img v-if="image && image.src" :src="image.src" class="cub-image-preview-img" @load="imageLoad" />
      <cub-video v-if="video && video.source" :source="video.source" :options="video.options"></cub-video>
    </view>
  </cub-swiper-item>
</template>
<script lang="ts">
