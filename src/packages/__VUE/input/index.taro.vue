<template>
  <view :class="classes" @click="onClick">
    <view class="cub-input-value">
      <view class="cub-input-inner">
        <view v-if="$slots.left" class="cub-input-left-box">
          <slot name="left"></slot>
        </view>
        <view class="cub-input-box">
          <component
            :is="renderInput(type)"
            v-bind="$attrs"
            class="input-text"
          ...
          ></component>
          <view v-if="readonly" class="cub-input-disabled-mask" @click="onClickInput"></view>
          <view v-if="showWordLimit && maxLength" class="cub-input-word-limit">
            <span class="cub-input-word-num">{{ modelValue ? modelValue.length : 0 }}</span
            >/{{ maxLength }}
          </view>
        </view>
        <view
          class="cub-input-clear-box"
          v-if="clearable && !readonly"
          v-show="(active || showClearIcon) && modelValue.length > 0"
          @click="clear"
        >
          <slot name="clear">
            <MaskClose class="cub-input-clear" :size="clearSize" :width="clearSize" :height="clearSize"> </MaskClose>
          </slot>
        </view>
        <view class="cub-input-right-box">
...
import { MaskClose } from '@cubfe/icons-vue-taro';
