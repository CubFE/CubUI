<template>
  <view :class="classes">
    <view
      class="cub-input-number__icon cub-input-number__left"
      :class="{ 'cub-input-number__icon--disabled': !reduceAllow() }"
      @click="reduce"
    >
      <slot name="left-icon">
    ...
    <view v-if="readonly" class="cub-input-number__text--readonly">
      {{ modelValue }}
    </view>
    <input
      v-else
      class="cub-input-number__text--input"
      type="number"
      :min="min"
      :max="max"
    ...
    />
    <view
      class="cub-input-number__icon cub-input-number__right"
      :class="{ 'cub-input-number__icon--disabled': !addAllow() }"
      @click="add"
    >
...
import { Minus, Plus } from '@cubfe/icons-vue-taro';
    ...
    watch(
      ...
      () => {
        if (Number(props.min) > Number(props.max)) {
          console.warn('[cubui] <InputNumber>', 'props.max < props.min');
        }
