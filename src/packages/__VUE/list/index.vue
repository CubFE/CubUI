<template>
  <div :class="classes" :style="{ height: `${getContainerHeight}px` }" @scroll.passive="handleScrollEvent" ref="list">
    <div class="cub-list-phantom" :style="{ height: phantomHeight + 'px' }" ref="phantom"></div>
    <div class="cub-list-container" :style="{ transform: getTransform() }" ref="actualContent">
      <div class="cub-list-item" v-for="(item, index) in visibleData" :key="item">
