<template>
  <div class="demo full">
    ...
    <cub-menu>
      <cub-menu-item v-model="state.value1" :options="options1" />
      <cub-menu-item v-model="state.value2" @change="handleChange" :options="options2" />
    </cub-menu>
    <h2>{{ translate('customMenuContent') }}</h2>
    <cub-menu>
      <cub-menu-item v-model="state.value1" :options="options1" />
      <cub-menu-item :title="translate('screen')" ref="item">
        <div :style="{ display: 'flex', flex: 1, 'justify-content': 'space-between', 'align-items': 'center' }">
          <div :style="{ marginRight: '10px' }">{{ translate('customContent') }}</div>
          <cub-button @click="onConfirm">{{ translate('confirm') }}</cub-button>
        </div>
      </cub-menu-item>
    </cub-menu>
    <h2>{{ translate('twoColsInOneLine') }}</h2>
    <cub-menu>
      <cub-menu-item v-model="state.value3" :cols="2" :options="options3" />
    </cub-menu>
    ...
    <cub-menu>
      <cub-menu-item disabled v-model="state.value1" :options="options1" />
      <cub-menu-item disabled v-model="state.value2" :options="options2" />
    </cub-menu>
  </div>
</template>
