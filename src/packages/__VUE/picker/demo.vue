<template>
  <div class="demo">
    ...
    <cub-picker :columns="columns" :title="translate('chooseCity')" @confirm="confirm"></cub-picker>

    <h2>{{ translate('popupDesc') }}</h2>
    <cub-cell :title="translate('chooseCity')" :desc="popupDesc" @click="show = true"></cub-cell>
    <cub-popup position="bottom" v-model:visible="show">
      <cub-picker
        ...
        @cancel="show = false"
      >
        <cub-button block type="primary">{{ translate('always') }}</cub-button>
      </cub-picker>
    </cub-popup>
    ...
    <cub-picker v-model="selectedValue" :columns="columns" :title="translate('chooseCity')" @confirm="confirm">
    </cub-picker>
    ...
    <cub-picker v-model="selectedTime" :columns="multipleColumns" :title="translate('chooseTime')" @confirm="confirm">
    </cub-picker>
