...
test('Searchbar: basic usage', () => {
  ...
  expect(wrapper.find('.cub-searchbar').html()).toMatchSnapshot();
});
...
test('Searchbar: backgrounds prop test', () => {
  ...
  const outer: any = wrapper.find('.cub-searchbar');
  const inner: any = wrapper.find('.cub-searchbar__search-input');
...
test('Searchbar: clear event test', async () => {
  ...
  const input = wrapper.find('input');
  const clear = wrapper.find('.cub-searchbar__input-clear');
...
test('Searchbar: props shape', async () => {
  ...
  const input1 = wrapper1.find('.cub-searchbar__search-input');
  const input2 = wrapper2.find('.cub-searchbar__search-input');
