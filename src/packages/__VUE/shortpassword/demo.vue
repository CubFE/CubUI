<template>
  <div class="demo">
    <cub-cell :title="translate('basic')" is-link @click="state.visible1 = true"></cub-cell>
    ...
    <cub-cell :title="translate('forgetPassword')" is-link @click="state.visible3 = true"> </cub-cell>
