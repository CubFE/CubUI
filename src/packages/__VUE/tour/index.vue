<template>
  <div :class="classes">
    <div class="cub-tour-masked" v-show="showTour" @click="handleClickMask"></div>

    <div v-for="(step, i) in steps" :key="i" style="height: 0">
      <template v-if="i == active">
        <div
          class="cub-tour-mask"
          :class="[mask ? '' : 'cub-tour-mask-none']"
          :style="maskStyle"
          v-if="showTour"
          id="cub-tour-popid"
        ></div>
        ...
        >
          <template #content>
            <slot>
              <div class="cub-tour-content" v-if="type == 'step'">
                <div class="cub-tour-content-top" v-if="showTitleBar">
                  <div @click="close">
                    <Close class="cub-tour-content-top-close" />
                  </div>
                </div>
                <div class="cub-tour-content-inner">
                  {{ step.content }}
                </div>
                <div class="cub-tour-content-bottom">
                  <div class="cub-tour-content-bottom-init">{{ active + 1 }}/{{ steps.length }}</div>
                  <div class="cub-tour-content-bottom-operate">
                    <slot name="prev-step">
                      <div
              ...
              <div class="cub-tour-content cub-tour-content-tile" v-if="type == 'tile'">
                <div class="cub-tour-content-inner">
                  {{ step.content }}
                </div>
              </div>
