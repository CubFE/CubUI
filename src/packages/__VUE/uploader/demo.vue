<template>
  <div class="demo bg-w">
    ...
    <cub-uploader :url="uploadUrl"></cub-uploader>
    <h2>{{ translate('title1') }}</h2>
    <cub-uploader :url="uploadUrl" v-model:file-list="defaultFileList" @delete="onDelete" maximum="3" multiple>
    </cub-uploader>
    <h2>{{ translate('title2') }}</h2>
    <cub-uploader :url="uploadUrl" v-model:file-list="defaultFileList1" maximum="10" multiple list-type="list">
      <cub-button type="success" size="small">{{ translate('uploadfile') }}</cub-button>
    </cub-uploader>
    <h2>{{ translate('title3') }}</h2>
    <cub-uploader :url="uploadUrl">
      <cub-button type="success" size="small">{{ translate('uploadfile') }}</cub-button>
    </cub-uploader>
    ...
    <cub-uploader :url="uploadUrl" capture></cub-uploader>
    <h2>{{ translate('title6') }}</h2>
    <cub-uploader :url="uploadUrl" multiple maximum="5"></cub-uploader>
    ...
    <cub-uploader :url="uploadUrl" method="put" :before-xhr-upload="beforeXhrUpload"></cub-uploader>
    <h2>{{ translate('title10') }}</h2>
    <cub-uploader :url="uploadUrl" maximum="5" :auto-upload="false" ref="uploadRef"></cub-uploader>
    <br />
    <cub-button type="success" size="small" @click="submitUpload">{{ translate('title11') }}</cub-button>
    <cub-button type="danger" size="small" @click="clearUpload">{{ translate('title14') }}</cub-button>
