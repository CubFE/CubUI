...
function install(app: App) {
  const packages = [Button,Cell,CellGroup,Overlay,Popup,ConfigProvider,Layout,Col,Row,Sticky,Divider,Grid,GridItem,Navbar,FixedNav,Menu,MenuItem,Tabbar,TabbarItem,Elevator,Pagination,Tabs,TabPane,Indicator,SideNavbar,SideNavbarItem,SubSideNavbar,Range,Searchbar,Cascader,Calendar,Checkbox,CheckboxGroup,DatePicker,InputNumber,Input,Radio,RadioGroup,Rate,Picker,ShortPassword,Textarea,Uploader,NumberKeyboard,Form,FormItem,Swipe,SwipeGroup,ActionSheet,Backtop,Drag,Dialog,Notify,Switch,Toast,Avatar,AvatarGroup,List,Progress,CircleProgress,Noticebar,Empty,Steps,Step,Swiper,SwiperItem,Price,ImagePreview,Countup,Countdown,Badge,Tag,Popover,Skeleton,Collapse,CollapseItem,Table,Animate,Ellipsis,Watermark,TrendArrow,Tour,Address,Barrage,Signature,TimeSelect,TimePannel,TimeDetail,Sku,Card,Ecard,AddressList,Category,CategoryPane,Comment,Invoice];
...
import './__VUE/button/index.scss';
...
import './__VUE/indicator/index.scss';
import './__VUE/sidenavbar/index.scss';
import './__VUE/sidenavbaritem/index.scss';
import './__VUE/subsidenavbar/index.scss';
...
import './__VUE/swipegroup/index.scss';
...
import './__VUE/skeleton/index.scss';
import './__VUE/collapse/index.scss';
import './__VUE/collapseitem/index.scss';
import './__VUE/table/index.scss';
import './__VUE/animate/index.scss';
import './__VUE/ellipsis/index.scss';
import './__VUE/watermark/index.scss';
import './__VUE/trendarrow/index.scss';
import './__VUE/tour/index.scss';
...
import './__VUE/ecard/index.scss';
import './__VUE/addresslist/index.scss';
import './__VUE/category/index.scss';
import './__VUE/categorypane/index.scss';
import './__VUE/comment/index.scss';
import './__VUE/invoice/index.scss';

export { install, Locale, Button,Cell,CellGroup,Overlay,Popup,ConfigProvider,Layout,Col,Row,Sticky,Divider,Grid,GridItem,Navbar,FixedNav,Menu,MenuItem,Tabbar,TabbarItem,Elevator,Pagination,Tabs,TabPane,Indicator,SideNavbar,SideNavbarItem,SubSideNavbar,Range,Searchbar,Cascader,Calendar,Checkbox,CheckboxGroup,DatePicker,InputNumber,Input,Radio,RadioGroup,Rate,Picker,ShortPassword,Textarea,Uploader,NumberKeyboard,Form,FormItem,Swipe,SwipeGroup,ActionSheet,Backtop,Drag,Dialog,Notify,Switch,Toast,Avatar,AvatarGroup,List,Progress,CircleProgress,Noticebar,Empty,Steps,Step,Swiper,SwiperItem,Price,ImagePreview,Countup,Countdown,Badge,Tag,Popover,Skeleton,Collapse,CollapseItem,Table,Animate,Ellipsis,Watermark,TrendArrow,Tour,Address,Barrage,Signature,TimeSelect,TimePannel,TimeDetail,Sku,Card,Ecard,AddressList,Category,CategoryPane,Comment,Invoice  };
export default { install, version:'1.0.1', Locale};