...
test('should render ActionSheet when visible is true', async () => {
  ...
  const menuItem = wrapper.findAll('.cub-action-sheet__item');
...
test('should emit select event after clicking option', async () => {
  ...
  const menuItem = wrapper.find('.cub-action-sheet__item');
...
test('should render sure actionsheet when use custom props', () => {
  ...
  const subdesc = wrapper.find('.cub-action-sheet__subdesc');
...
test('should render sure choose when use choose-tag-value', async () => {
  ...
  const item = wrapper.findAll<HTMLElement>('.cub-action-sheet__item');
...
test('should not emit select event after clicking disabled option', async () => {
  ...
  wrapper.find('.cub-action-sheet__item').trigger('click');
  await nextTick();
...
test('should render description when use description', async () => {
  ...
  const desc = wrapper.find('.cub-action-sheet__desc');
  const title = wrapper.find('.cub-action-sheet__title');
...
test('should emit cancel event after clicking cancel ', () => {
  ...
  wrapper.find('.cub-action-sheet__cancel').trigger('click');
