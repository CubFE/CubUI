<template>
  <div class="demo">
    ...
    <cub-cell :showIcon="true" :isLink="true" @click="switchActionSheet('isVisible2')">
      <span
        ><label>{{ translate('showCancelButton') }}</label></span
      >
      <div v-html="state.val2"></div>
    </cub-cell>
    <cub-cell :isLink="true" @click="switchActionSheet('isVisible3')">
      <span
    ...
    <cub-cell :isLink="true" @click="switchActionSheet('isVisible4')">
      <span
    ...
    <cub-cell :isLink="true" @click="switchActionSheet('isVisible5')">
      <span
    ...
    ></cub-action-sheet>
    <!-- 自定义面板-->
    <cub-action-sheet v-model:visible="state.isVisible5" :title="translate('title')">
