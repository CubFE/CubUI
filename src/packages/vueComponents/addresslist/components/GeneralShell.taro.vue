<template>
  <div class="cub-address-list-general" v-if="!swipeEdition">
    ...
    <div class="cub-address-list-general__mask" v-if="longPress && showMaskRef" @click="maskClick">
      <slot name="longpress-all">
        <div class="cub-address-list-general__mask-copy" @click="copyCLick"> 复制地址 </div>
        <div class="cub-address-list-general__mask-set" @click="setDefault"> 设置默认 </div>
        <div class="cub-address-list-general__mask-del" @click="delLongClick"> 删除地址 </div>
      </slot>
    </div>
    <div class="cub-address-list__mask-bottom" v-if="showMaskRef" @click="hideMaskClick"></div>
  </div>
  <cub-swipe v-else>
    <div class="cub-address-list-swipe">
    ...
    <template #right>
      <slot name="swipe-right-btn">
        <cub-button shape="square" style="height: 100%" type="danger" @click="swipeDelClick">删除</cub-button>
      </slot>
    </template>
  </cub-swipe>
</template>
