<template>
  <div class="demo" id="elId">
    ...
    <cub-backtop @click="handleClick" el-id="elId" :distance="100" :bottom="110">
      <view class="backtop-demo">
        <Top width="12px" height="12px" class="cub-backtop-main"></Top>
        <view class="title">{{ translate('backText') }}</view>
      </view>
    </cub-backtop>
    <cub-backtop @click="handleClick" el-id="elId" :distance="200" :bottom="50"></cub-backtop>
  </div>
</template>
...
import { Top } from '@cubfe/icons-vue';
const initTranslate = () =>
  useTranslate({
