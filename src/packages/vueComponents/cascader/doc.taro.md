...
import { Cascader } from '@cubui/cubui-taro';
...
```html
<template>
  <cub-cell title="选择地址" :desc="demo1.value.toString() || '请选择地址'" @click="demo1.visible = true"> </cub-cell>
  <cub-cascader
    title="地址选择"
...
```html
<template>
  <cub-cell title="选择地址" :desc="demo2.value.toString() || '请选择地址'" @click="demo2.visible = true"> </cub-cell>
  <cub-cascader
    title="地址选择"
...
```html
<template>
  <cub-cell title="选择地址" :desc="demo3.value.toString() || '请选择地址'" @click="demo3.visible = true"> </cub-cell>
  <cub-cascader
    title="地址选择"
...
```html
<template>
  <cub-cell title="选择地址" :desc="demo4.value.toString() || '请选择地址'" @click="demo4.visible = true"> </cub-cell>
  <cub-cascader
    title="地址选择"
...
```html
<template>
  <cub-cell title="选择地址" :desc="demo5.value.toString() || '请选择地址'" @click="demo5.visible = true"> </cub-cell>
  <cub-cascader
    title="地址选择"
