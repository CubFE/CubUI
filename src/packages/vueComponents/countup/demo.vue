<template>
  <div class="demo">
    ...
    <div class="show-demo">
      ...
      <cub-countup :init-num="150.0" :end-num="0.0" :speed="6.18" :to-fixed="2"></cub-countup>
      <cub-countup :init-num="500.0" :end-num="0.0" :speed="50" :to-fixed="2"></cub-countup>
    </div>
    <!-- <h2>{{ translate('title') }}</h2>
    <div class="show-demo">
      <cub-countup :scrolling="true" :init-num="18.618" :during="600"></cub-countup>
    </div> -->
    ...
    <div class="show-demo">
      ...
      <div class="btnBtn">
        <cub-button type="danger" @click="startRole" :disabled="startFlag">{{ translate('btn1') }}</cub-button>
        <cub-button type="danger" @click="startRole2" :disabled="startFlag">{{ translate('btn2') }}</cub-button>
      </div>
    </div>
  </div>
</template>
