<template>
  <view class="cub-countup">
    <template v-if="customBgImg != ''">
      <template v-if="type == 'machine'">
        <view class="cub-countup__machine" :style="{ height: numHeight + 'px' }">
          <view
            class="cub-countup__machine-item"
      ...
      <template v-else>
        <view class="cub-countup__numberimg" :style="{ height: numHeight + 'px' }">
          <view
            class="cub-countup__numberimg__item"
    ...
    <template v-else>
      ...
      >
        <view
          ref="cub-countup__number-item"
          class="cub-countup__number-item"
          v-for="(val, index) of num_total_len"
          :key="val"
          :style="{
        ...
        >
          <view
            ...
            class="cub-countup__number-item__span"
            :key="'dote' + idx"
            :style="{
              width: numWidth + 'px',
              height: numHeight + 'px',
...
export default create({
  ...
  setup(props, { emit }) {
    ...
    const countGo = (flag?: number): void => {
      ...
      if (scrolling && !customBgImg) {
        ...
        nextTick(() => {
          ...
          let refsDom = document.getElementsByClassName('cub-countup__number-item');
    ...
    const imgNumberScroll = () => {
      ...
      // }
      nextTick(() => {
        let f = document.getElementsByClassName('cub-countup__numberimg')[0];
        // setTimeout(() => {
