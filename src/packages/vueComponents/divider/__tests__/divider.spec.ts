...
test('Divider: content-position props', () => {
  ...
  const divider: any = wrapper.find('.cub-divider');
  expect(divider.classes()).toContain('cub-divider-left');
});
...
test('Divider: dashed props', () => {
  ...
  const divider: any = wrapper.find('.cub-divider');
  expect(divider.classes()).toContain('cub-divider-dashed');
});
...
test('Divider: custom style', () => {
  ...
  const _html = wrapper.find('.cub-divider');
...
test('Divider: hairline props', async () => {
  ...
  const divider: any = wrapper.find('.cub-divider');
  expect(divider.classes()).toContain('cub-divider-hairline');
  await wrapper.setProps({ hairline: false });
  expect(wrapper.classes('cub-divider-hairline')).toBe(false);
});
...
test('Divider: direction props', () => {
  ...
  const divider: any = wrapper.find('.cub-divider');
  expect(divider.classes()).toContain('cub-divider-vertical');
});
