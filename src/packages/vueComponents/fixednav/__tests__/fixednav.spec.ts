...
describe('FixedNav', () => {
  test('base cub-fixed-nav', () => {
    const wrapper = mount(FixedNav);
    const rate = wrapper.find('.cub-fixed-nav');
  ...
  test('should be displayed after setting the visible', () => {
    ...
    const list = wrapper.find('.cub-fixed-nav__list');
  ...
  test('should be displayed after setting the un-active-text', async () => {
    ...
    const overlay = wrapper.find('.cub-overlay');
    expect(overlay.exists()).toBe(true);
    const button = wrapper.find('.cub-fixed-nav__btn');
    expect(button.html()).toContain('展开');
    wrapper.find('.cub-fixed-nav__btn').trigger('click');
    await nextTick();
  ...
  test('should be displayed after setting the position', () => {
    ...
    const fixedNav = wrapper.find('.cub-fixed-nav');
