<template>
  ...
  >
    <view
      class="cub-cell__title cub-form-item__label"
      :style="labelStyle"
    ...
    <view class="cub-cell__value cub-form-item__body">
      <view class="cub-form-item__body__slots" :style="bodyStyle">
        <slot></slot>
      </view>
      <view class="cub-form-item__body__tips" :style="errorMessageStyle" v-if="parent[prop] && showErrorMessage">
        {{ parent[prop] }}</view
      >
    </view>
  </cub-cell>
