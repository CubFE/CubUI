<template>
  <div class="demo full">
    ...
    <cub-grid>
      <cub-grid-item :text="translate('text')">
        <Category />
      </cub-grid-item>
      <cub-grid-item :text="translate('text')">
        <Category />
    ...
    <cub-grid :column-num="3">
      ...
      <cub-grid-item :text="translate('text')">
        <Category height="40px" width="40px" color="#478EF2" />
      </cub-grid-item>
      <cub-grid-item :text="translate('text')">
        <Category />
      </cub-grid-item>
    ...
    <cub-grid :column-num="2">
      <cub-grid-item :text="translate('vueRouter')" to="/">
        <Home />
      </cub-grid-item>
      <cub-grid-item :text="translate('url')" url="https://kakusoft.com">
        <Search />
      </cub-grid-item>
    </cub-grid>
    ...
    <cub-grid :border="false">
      <cub-grid-item v-for="i in 4" :key="i">
        <cub-avatar size="large">
          <img
            src="https://oss.netconcepts.cn/website/assets/media/modules/service/img-6-800x600.jpg"
          />
        </cub-avatar>
      </cub-grid-item>
    </cub-grid>
...
import {Category, Home, Search } from '@cubfe/icons-vue';
const initTranslate = () =>
  useTranslate({
    'zh-CN': {
      basic: '基础用法',
...
export default defineComponent({
  components: { Category, Home, Search },
  props: {},
  setup() {
    initTranslate();
    let a = new Map([
