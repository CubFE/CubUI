<template>
  <div class="demo cub-infiniteloading-demo">
    <cub-tabs v-model="tabsValue" @change="chagetabs">
      <cub-tab-pane :title="translate('basic')">
        <ul class="infiniteUl">
      ...
      <cub-tab-pane :title="translate('customTxt')">
        <ul class="infiniteUl">
          <cub-infinite-loading
