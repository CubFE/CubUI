...
describe('function notify', () => {
  test('show text notify', async () => {
    ...
    const textNotify = document.querySelector('.cub-notify') as HTMLElement;
  ...
  test('show primary notify', async () => {
    ...
    const textNotify1 = document.querySelector('.cub-notify--primary') as HTMLElement;
  ...
  test('show success notify', async () => {
    ...
    const textNotify1 = document.querySelector('.cub-notify--success') as HTMLElement;
  ...
  test('show danger notify', async () => {
    ...
    const textNotify1 = document.querySelector('.cub-notify--danger') as HTMLElement;
  ...
  test('show warn notify', async () => {
    ...
    const textNotify1 = document.querySelector('.cub-notify--warning') as HTMLElement;
