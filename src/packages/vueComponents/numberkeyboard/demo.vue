<template>
  <div class="demo">
    <cub-cell :isLink="true" @touchstart.stop="showKeyBoard(1)" :title="translate('basic')"></cub-cell>
    <cub-number-keyboard v-model:visible="visible1" @blur="onBlur(1)" @input="input" @delete="onDelete">
    </cub-number-keyboard>
    <cub-cell :isLink="true" @touchstart.stop="showKeyBoard(2)" :title="translate('sidebar')"></cub-cell>
    <cub-number-keyboard
      type="rightColumn"
    ...
    <cub-cell :isLink="true" @touchstart.stop="showKeyBoard(3)" :title="translate('randomKeyOrder')"></cub-cell>
    <cub-number-keyboard
      type="rightColumn"
    ...
    <cub-cell :isLink="true" @touchstart.stop="showKeyBoard(4)" :title="translate('withTitle')"></cub-cell>
    <cub-number-keyboard
    ...
    <cub-cell :isLink="true" @touchstart.stop="showKeyBoard(6)" :title="translate('idNumberKeyboard')"></cub-cell>
    <cub-number-keyboard
    ...
    ></cub-cell>
    <cub-number-keyboard v-model:visible="visible5" v-model="value" maxlength="6" @blur="onBlur(5)" @close="close(5)">
    </cub-number-keyboard>
  </div>
</template>
