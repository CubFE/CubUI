<template>
  <div ref="root">
    <cub-popup v-model:visible="show" position="bottom" :popClass="popClass" :overlay="false" :teleportDisable="false">
      <div class="cub-number-keyboard">
        <div class="cub-number-keyboard__header" v-if="title">
          <h3 class="cub-number-keyboard__title">{{ title }}</h3>
          <span class="cub-number-keyboard__close" v-if="type == 'default'" @click="closeBoard()">{{
            translate('done')
          }}</span>
        </div>
        <div class="cub-number-keyboard__body">
          <div class="cub-number-keyboard__keys">
            <div
            ...
            >
              <div
                :class="[
                  'cub-key',
                  { 'cub-key--active': item.id == clickKeyIndex },
                  { 'cub-key--lock': item.type == 'lock' },
                  { 'cub-key--delete': item.type == 'delete' }
                ]"
          ...
          <div class="cub-number-keyboard__sidebar" v-if="type == 'rightColumn'">
            <div class="cub-key__wrapper">
              <div
                :class="['cub-key', { active: clickKeyIndex == 'delete' }]"
            ...
            <div class="cub-key__wrapper cub-key__wrapper--finish" @click="closeBoard()">
              <div :class="['cub-key', 'cub-key--finish ', { activeFinsh: clickKeyIndex == 'finish' }]">
