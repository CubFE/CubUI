<template>
  <div class="demo">
    ...
    <cub-pagination v-model="currentPage2" :total-items="125" :show-page-size="3" force-ellipses @change="pageChange" />
    <h2>{{ translate('customButton') }}</h2>
    <cub-pagination v-model="currentPage3" :total-items="500" :show-page-size="5" @change="pageChange">
      <template #prev-text>
