<template>
  <div class="cub-popover-wrapper" @click="openPopover" ref="popoverRef" v-if="!targetId"
    ><slot name="reference"></slot
  ></div>
  <view :class="['cub-popover', `cub-popover--${theme}`, `${customClass}`]" :style="getRootPosition">
    <cub-popup
    ...
    >
      <view ref="popoverContentRef" class="cub-popover-content-group">
        <view :class="popoverArrow" v-if="showArrow" :style="popoverArrowStyle"> </view>
        <slot name="content"></slot>
        <view
          v-for="(item, index) in list"
          :key="index"
          :class="[item.className, item.disabled && 'cub-popover-menu-disabled', 'cub-popover-menu-item']"
