<template>
  <div :class="classes" ref="scroller" @touchstart="touchStart" @touchmove="touchMove" @touchend="touchEnd">
    <div class="cub-pull-refresh-container" :style="getStyle">
      <div class="cub-pull-refresh-container-topbox" :style="getHeightStyle">
        <Loading
          class="cub-icon-loading cub-pull-refresh-container-topbox-icon"
          v-if="status == 'loading' && !slots.loading"
        ></Loading>

        <div class="cub-pull-refresh-container-topbox-text">{{ getPullStatus }}</div>
