...
test('should render range when used ', async () => {
  ...
  const inner = wrapper.find<HTMLElement>('.cub-range-button .number');
...
test('should render two buttons when use range props', async () => {
  ...
  const left = wrapper.find<HTMLElement>('.cub-range-button-wrapper-left .number');
  const right = wrapper.find<HTMLElement>('.cub-range-button-wrapper-right .number');
...
test('should set min and max when use min and max props', async () => {
  ...
  const min = wrapper.find<HTMLElement>('.cub-range-min');
  const max = wrapper.find<HTMLElement>('.cub-range-max');
  const btn = wrapper.find<HTMLElement>('.cub-range-button .number');
...
test('should change color template when use color props', async () => {
  ...
  await nextTick();
  const root = wrapper.find<HTMLElement>('.cub-range');
  const bar = wrapper.find<HTMLElement>('.cub-range-bar');
  const btn = wrapper.find<HTMLElement>('.cub-range-button');
...
test('should render slots template when use slots', async () => {
  ...
  const btn = wrapper.find<HTMLElement>('.cub-range-button-wrapper');
...
test('should not render elements  when use hidden elements props', async () => {
  ...
  expect(wrapper.find<HTMLElement>('.cub-range-button').exists()).toBe(true);
  expect(wrapper.find<HTMLElement>('.min').exists()).toBe(false);
  expect(wrapper.find<HTMLElement>('.max').exists()).toBe(false);
  expect(wrapper.find<HTMLElement>('.cub-range-button .number').exists()).toBe(false);
});
...
test('should not allow to click slider when disabled', async () => {
  ...
  const range = wrapper.find('.cub-range');
...
test('should emit "change" event after dragging button', () => {
  ...
  const button = wrapper.find('.cub-range-button');
