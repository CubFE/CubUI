<template>
  <div class="demo">
    ...
    <cub-cell class="cell">
      <cub-range v-model="value1" @change="onChange"></cub-range>
    </cub-cell>
    <h2>{{ translate('title1') }}</h2>
    <cub-cell class="cell">
      <cub-range range v-model="value2" @change="onChange"></cub-range>
    </cub-cell>
    <h2>{{ translate('title2') }}</h2>
    <cub-cell class="cell">
      <cub-range v-model="value3" :max="10" :min="-10" @change="onChange"></cub-range>
    </cub-cell>
    <h2>{{ translate('title3') }}</h2>
    <cub-cell class="cell">
      <cub-range v-model="value4" :step="5" @change="onChange"></cub-range>
    </cub-cell>
    <h2>{{ translate('title4') }}</h2>
    <cub-cell class="cell">
      <cub-range hidden-range v-model="value5" @change="onChange"></cub-range>
    </cub-cell>
    <h2>{{ translate('title5') }}</h2>
    <cub-cell class="cell">
      <cub-range hidden-tag v-model="value6" @change="onChange"></cub-range>
    </cub-cell>
    <h2>{{ translate('title6') }}</h2>
    <cub-cell class="cell">
      <cub-range disabled v-model="value7"></cub-range>
    </cub-cell>
    ...
    <cub-cell class="cell">
      <cub-range v-model="value9" @change="onChange">
        <template #button>
...
.custom-button {
  ...
  line-height: 18px;
  text-align: center;
  background-color: rgba(0, 46, 166, 1);
  border-radius: 100px;
}
