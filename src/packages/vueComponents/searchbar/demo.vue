<template>
  <div class="demo full">
    ...
    <cub-searchbar v-model="searchValue" :label="translate('word1')" :focus-style="{ outline: '1px solid red' }">
    </cub-searchbar>
    ...
    <cub-searchbar v-model="searchValue1" @search="search"> </cub-searchbar>
    ...
    <cub-searchbar v-model="searchValue3">
    ...
    <cub-searchbar v-model="searchValue6">
      <template #clear-icon>
    ...
    <cub-searchbar v-model="searchValue5" @click-right-icon="clickRightIcon">
      <template #leftout>
