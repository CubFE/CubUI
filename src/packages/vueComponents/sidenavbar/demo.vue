<template>
  <div class="demo">
    ...
    <cub-popup position="right" v-model:visible="show1" :style="{ width, height }">
      <cub-side-navbar>
        <cub-sub-side-navbar :title="translate('title1')" ikey="6">
          <cub-sub-side-navbar :title="translate('title2')" ikey="9">
            <cub-side-navbar-item ikey="10" :title="translate('title3')"></cub-side-navbar-item>
            <cub-side-navbar-item ikey="11" :title="translate('title4')"></cub-side-navbar-item>
          </cub-sub-side-navbar>
          <cub-sub-side-navbar :title="translate('title16')" ikey="12">
            <cub-side-navbar-item ikey="13" :title="translate('title5')"></cub-side-navbar-item>
            <cub-side-navbar-item ikey="14" :title="translate('title6')"></cub-side-navbar-item>
          </cub-sub-side-navbar>
        </cub-sub-side-navbar>
      </cub-side-navbar>
    </cub-popup>
    ...
    <cub-popup position="left" v-model:visible="show2" :style="{ width, height }">
      <cub-side-navbar>
        <cub-sub-side-navbar :title="translate('title7')" ikey="3" :open="false">
          <cub-side-navbar-item ikey="4" :title="translate('title8')"></cub-side-navbar-item>
          <cub-side-navbar-item ikey="5" :title="translate('title9')"></cub-side-navbar-item>
        </cub-sub-side-navbar>
        <cub-sub-side-navbar :title="translate('title10')" ikey="12">
          <cub-side-navbar-item ikey="13" :title="translate('title11')"></cub-side-navbar-item>
          <cub-side-navbar-item ikey="14" :title="translate('title12')"></cub-side-navbar-item>
        </cub-sub-side-navbar>
      </cub-side-navbar>
    </cub-popup>
    ...
    <div>
      ...
      <cub-popup position="right" v-model:visible="show3" :style="{ width, height }">
        <cub-side-navbar :show="show3">
          ...
          ></cub-side-navbar-item>
          <cub-side-navbar-item ikey="2" :title="translate('title10')"></cub-side-navbar-item>
          <cub-sub-side-navbar :title="translate('title7')" ikey="3" :open="false">
            <cub-side-navbar-item ikey="4" :title="translate('title8')"></cub-side-navbar-item>
            <cub-side-navbar-item ikey="5" :title="translate('title9')"></cub-side-navbar-item>
          </cub-sub-side-navbar>
          <cub-sub-side-navbar :title="translate('title1')" ikey="6">
            <cub-side-navbar-item ikey="7" :title="translate('title14')"></cub-side-navbar-item>
            <cub-side-navbar-item ikey="8" :title="translate('title15')"></cub-side-navbar-item>
            <cub-sub-side-navbar :title="translate('title2')" ikey="9">
              <cub-side-navbar-item ikey="10" :title="translate('title3')"></cub-side-navbar-item>
              <cub-side-navbar-item ikey="11" :title="translate('title4')"></cub-side-navbar-item>
            </cub-sub-side-navbar>
