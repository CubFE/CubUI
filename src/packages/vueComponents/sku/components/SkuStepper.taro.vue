<template>
  <view class="cub-sku-stepper">
    <view class="cub-sku-stepper-title">{{ stepperTitle }}</view>
    <view class="cub-sku-stepper-limit" v-html="getExtraText()"></view>
    <view class="cub-sku-stepper-count">
      <cub-input-number
        v-model="goodsCount"
        :min="stepperMin"
        :max="stepperMax"
