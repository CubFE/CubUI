<template>
  ...
  >
    <view class="cub-swipe__left" ref="leftRef" @click="onClick($event, 'left', true)">
      <slot name="left"></slot>
    </view>

    <view class="cub-swipe__content" @click="onClick($event, 'content', lockClick)">
      <slot name="default"></slot>
    </view>

    <view class="cub-swipe__right" ref="rightRef" @click="onClick($event, 'right', true)">
