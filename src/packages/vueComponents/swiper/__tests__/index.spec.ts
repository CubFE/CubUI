...
test('should render width and height', async () => {
  const wrapper = mount({
    components: {
      'cub-swiper': Swiper,
      'cub-swiper-item': SwiperItem
    },
    template: `
        <cub-swiper :init-page="page" :pagination-visible="true" pagination-color="#426543" auto-play="2000" :height="height">
  ...
  const swiperItem = wrapper.findAll('.cub-swiper-inner')[0].element as HTMLElement;
...
test('should render initpage', async () => {
  const wrapper = mount({
    ...
    template: `
        <cub-swiper :init-page="page" :width="width">
          <cub-swiper-item v-for="item in list" :key="item">
            <img :src="item" alt="" />
          </cub-swiper-item>
        </cub-swiper>
...
test('should render direction', async () => {
  const wrapper = mount({
    ...
    template: `
        <cub-swiper :init-page="page" :height="height" :direction="direction">
          <cub-swiper-item v-for="item in list" :key="item">
            <img :src="item" alt="" />
          </cub-swiper-item>
        </cub-swiper>
...
test('should render pagination', async () => {
  const wrapper = mount({
    ...
    template: `
        <cub-swiper :init-page="page" :pagination-visible="paginationVisible" :pagination-color="paginationColor">
          <cub-swiper-item v-for="item in list" :key="item">
            <img :src="item" alt="" />
          </cub-swiper-item>
        </cub-swiper>
...
test('should render loop and auto-play', async () => {
  ...
  const wrapper = mount({
    ...
    template: `
        <cub-swiper :init-page="page" :auto-play="autoPlay" :width="width" @change="change">
          <cub-swiper-item v-for="item in list" :key="item">
            <img :src="item" alt="" />
          </cub-swiper-item>
        </cub-swiper>
...
test('should not allow to drag when touchable is false', async () => {
  ...
  const track = wrapper.find('.cub-swiper-inner');
...
test('should not allow to drag when loop is false', async () => {
  const wrapper = mount({
    ...
    template: `
        <cub-swiper :init-page="page" :auto-play="autoPlay" :width="width" :loop="loop" @change="change">
          <cub-swiper-item v-for="item in list" :key="item">
            <img :src="item" alt="" />
          </cub-swiper-item>
        </cub-swiper>
...
test('should swiper to prev swiper after calling prev method', async () => {
  const wrapper = mount({
    ...
    template: `
        <cub-swiper :init-page="page" :auto-play="autoPlay" @change="change" ref="swiper">
          <cub-swiper-item v-for="item in list" :key="item">
            <img :src="item" alt="" />
          </cub-swiper-item>
        </cub-swiper>
