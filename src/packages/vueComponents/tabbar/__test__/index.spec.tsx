...
import { Home, Category, Find } from '@cubfe/icons-vue';
...
test('should render tabbar when default', async () => {
  ...
  await nextTick();
  expect(wrapper.find('.cub-tabbar').exists()).toBe(true);
  expect(wrapper.find('.cub-tabbar-item').exists()).toBe(true);
...
test('should render custom img when using img prop', async () => {
  ...
  await nextTick();
  const tabbarItemIcon: any = wrapper.findAll('.cub-tabbar-item_icon-box_icon img');
...
test('should render custom color and bage when using prop', async () => {
  ...
  await nextTick();
  const tabbarItem: any = wrapper.findAll('.cub-tabbar-item');
  ...
  expect(wrapper.find<HTMLElement>('.cub-badge').exists()).toBe(true);
});
