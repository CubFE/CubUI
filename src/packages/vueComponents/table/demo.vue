<template>
  <div class="demo">
    ...
    <cub-table :columns="columns1" :data="data1"></cub-table>
    <h2>{{ translate('title1') }}</h2>
    <cub-table :columns="columns2" :data="data1" :bordered="bordered1"></cub-table>
    <h2>{{ translate('title2') }}</h2>
    <cub-table :columns="columns3" :data="data2" :summary="summary"></cub-table>
    <h2>{{ translate('title3') }}</h2>
    <cub-table :columns="columns3" :data="data2" :striped="striped"></cub-table>
    <h2>{{ translate('title4') }}</h2>
    <cub-table :columns="columns3" :data="data3"> </cub-table>
    <br />
    ...
    <cub-table :columns="columns4" :data="data4"> </cub-table>
    <h2>{{ translate('title7') }}</h2>
    <cub-table :columns="columns3" :data="data5"> </cub-table>
    <h2>{{ translate('title8') }}</h2>
    <cub-table :columns="columns6" :data="data6" @sorter="handleSorter"> </cub-table>
  </div>
</template>
