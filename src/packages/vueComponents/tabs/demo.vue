<template>
  <div class="demo full">
    ...
    <cub-tabs v-model="state.tab3value">
      <cub-tab-pane v-for="item in state.list3" :title="'Tab ' + item" :key="item"> Tab {{ item }} </cub-tab-pane>
    </cub-tabs>

    <h2>{{ translate('title4') }}</h2>
    <cub-tabs v-model="state.tab4value" title-scroll title-gutter="10">
      <cub-tab-pane v-for="item in state.list4" :title="'Tab ' + item" :key="item"> Tab {{ item }} </cub-tab-pane>
    </cub-tabs>
    <h2>{{ translate('title10') }}</h2>
    <cub-tabs v-model="state.tab4value" title-scroll direction="vertical" style="height: 150px">
      <cub-tab-pane v-for="item in state.list4" :title="'Tab ' + item" :key="item"> Tab {{ item }} </cub-tab-pane>
    </cub-tabs>
    <h2>{{ translate('title5') }}</h2>
    <cub-tabs style="height: 300px" v-model="state.tab5value" title-scroll direction="vertical">
      <cub-tab-pane v-for="item in state.list5" :pane-key="item" :title="'Tab ' + item" :key="item">
        Tab {{ item }}
      </cub-tab-pane>
    </cub-tabs>
    ...
    <cub-tabs v-model="state.tab8value" size="large">
      <cub-tab-pane title="Tab 1"> Tab 1 </cub-tab-pane>
      <cub-tab-pane title="Tab 2"> Tab 2 </cub-tab-pane>
      <cub-tab-pane title="Tab 3"> Tab 3 </cub-tab-pane>
    </cub-tabs>
    <cub-tabs v-model="state.tab8value" size="normal">
      <cub-tab-pane title="Tab 1"> Tab 1 </cub-tab-pane>
      <cub-tab-pane title="Tab 2"> Tab 2 </cub-tab-pane>
      <cub-tab-pane title="Tab 3"> Tab 3 </cub-tab-pane>
    </cub-tabs>
    <cub-tabs v-model="state.tab8value" size="small">
      <cub-tab-pane title="Tab 1"> Tab 1 </cub-tab-pane>
      <cub-tab-pane title="Tab 2"> Tab 2 </cub-tab-pane>
      <cub-tab-pane title="Tab 3"> Tab 3 </cub-tab-pane>
    </cub-tabs>
    ...
    <cub-tabs v-model="state.tab7value">
      ...
      <cub-tab-pane v-for="item in state.list6" :pane-key="item.paneKey" :key="item.paneKey">
        {{ item.title }}
      </cub-tab-pane>
    </cub-tabs>
  </div>
