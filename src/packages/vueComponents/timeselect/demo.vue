<template>
  <div class="demo">
    ...
    >
      <template #pannel>
        <cub-time-pannel :name="translate('time1')" pannel-key="0" @change="handleChange1"></cub-time-pannel>
        <cub-time-pannel :name="translate('time2')" pannel-key="1" @change="handleChange1"></cub-time-pannel>
      </template>
      <template #detail>
    ...
    >
      <template #pannel>
        <cub-time-pannel :name="translate('time1')" pannel-key="0" @change="handleChange2"></cub-time-pannel>
        <cub-time-pannel :name="translate('time2')" pannel-key="1" @change="handleChange2"></cub-time-pannel>
      </template>
      <template #detail>
