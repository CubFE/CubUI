    ...
    <view class="cub-uploader__preview" :class="[listType]" v-for="(item, index) in fileList" :key="item.uid">
      <view class="cub-uploader__preview-img" v-if="listType == 'picture' && !$slots.default">
        ...
        <view v-else class="cub-uploader__preview-img__file">
          <view @click="fileItemClick(item)" class="cub-uploader__preview-img__file__name">
      ...
      <view class="cub-uploader__preview-list" v-else-if="listType == 'list'">
        <view @click="fileItemClick(item)" class="cub-uploader__preview-img__file__name" :class="[item.status]">
...
import { Photograph, Failure, Loading, Trash, Link } from '@cubfe/icons-vue';
  ...
  setup(props, { emit }) {
    ...
    const executeUpload = (fileItem: FileItem, index: number) => {
      ...
      try {
        ...
        console.warn('[cubui] <Uploader> formData.get(name)', error);
      }
