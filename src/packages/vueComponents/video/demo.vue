<template>
  <div class="demo">
    ...
    <cub-cell class="cell">
      <cub-video :source="source" :options="options1" @play="play" @pause="pause" @playend="playend"> </cub-video>
    </cub-cell>
    <h4>{{ translate('title2') }}</h4>
    <cub-cell class="cell">
      <cub-video :source="source" :options="options2" @play="play" @pause="pause" @playend="playend"> </cub-video>
    </cub-cell>
    <h4>{{ translate('title3') }}</h4>
    <cub-cell class="cell">
      <cub-video :source="source" :options="options3" @play="play" @pause="pause" @playend="playend"> </cub-video>
    </cub-cell>
    <h4>{{ translate('title4') }}</h4>
    <cub-cell class="cell">
      <cub-video :source="source" :options="options4" @play="play" @pause="pause" @playend="playend"> </cub-video>
    </cub-cell>
    <h4>{{ translate('title5') }}</h4>
    <cub-cell class="cell">
      <cub-video :source="source" :options="options5" @play="play" @pause="pause" @playend="playend"> </cub-video>
    </cub-cell>
    <h4>{{ translate('title6') }}</h4>
    <cub-cell class="cell">
      <cub-video :source="source1" :options="options" @play="play" @pause="pause" @playend="playend"> </cub-video>
    </cub-cell>
    <cub-button type="primary" @click="changeVideo" class="m-b">{{ translate('title6') }}</cub-button>
  </div>
</template>
...
export default defineComponent({
  ...
  setup() {
    ...
    const state = reactive({
      ...
      source1: {
        src: 'https://storage.360buyimg.com/cubui/video/legao-%E6%9D%A8%E8%BF%9B%E5%86%9B.mp4',
        type: 'video/mp4'
      },
      options: {
        controls: true
